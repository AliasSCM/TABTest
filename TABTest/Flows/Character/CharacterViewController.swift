...
{
  //func displaySomething(viewModel: Character.Something.ViewModel)
}

class CharacterViewController: UIViewController, CharacterDisplayLogic
{
  ...
  /*func doSomething()
  {
    let request = Character.Something.Request()
